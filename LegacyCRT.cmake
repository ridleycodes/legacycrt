...
FUNCTION(__LEGACY_CRT_GET_FLAGS COMPILE_FLAGS LINK_FLAGS IS_DLL IS_CONSOLE APPEND_ENTRY_POINT)
    ...
    IF(MSVC)
        ...
        IF(CMAKE_C_COMPILER_ID MATCHES "Clang" OR NOT MSVC_VERSION LESS 1300)
                SET(_LF "${_LF} /SAFESEH:NO")
        ENDIF(CMAKE_C_COMPILER_ID MATCHES "Clang" OR NOT MSVC_VERSION LESS 1300)
